    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('postUpdateUser', $row->id) }}" method="post" enctype="multipart/form-data"
                        autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <input type="text" title="Name" class="form-control" name="name" id="name"
                                        value="{{ old('name', $row->name) }}" placeholder="Enter Name" required>
                                    @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <input type="email" title="Email" class="form-control" name="email" id="email"
                                        value="{{ old('email', $row->email) }}" placeholder="Enter Email" required>
                                    @error('email')
                                        <div class="text-danger mt-1" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    <label for="phone" class="form-label">Phone Number
                                        ...
                                        <small class="text-danger">(+1 required in first place)</small>
                                    </label>
                                    <input type="text" title="Phone Number" class="form-control" name="phone"
                                        id="phone_number" maxlength="16" value="{{ old('phone', $row->phone) }}"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <input type="text" title="Vehicle Make" class="form-control" name="vehicle_make"
                                        id="vehicle_make" value="{{ old('vehicle_make', $row->vehicle_make) }}"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    <label for="vehicle_model" class="form-label">Vehicle Mode</span></label>
                                    <input type="text" title="vehicle model" class="form-control" name="vehicle_model"
                                        id="vehicle_model" value="{{ old('vehicle_model', $row->vehicle_model) }}"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <input type="text" title="vehicle_color" class="form-control"
                                        name="vehicle_color" id="vehicle_color"
                                        value="{{ old('vehicle_color', $row->vehicle_color) }}"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3 ">
                                    ...
                                    <input type="text" title="registration number" class="form-control"
                                        ...
                                        value="{{ old('registration_number', $row->registration_number) }}"
                            ...
                            {{-- <div class="col-md-12">
                                <div class="mb-3 ">
                                    <label for="fuel_cost_per_km" class="form-label">Fuel Cost 1/KM </label>
                                    <input type="text" title="Fuel Cost 1/KM" class="form-control"
                                        name="fuel_cost_per_km" id="fuel_cost_per_km"
                                        value="{{ old('fuel_cost_per_km', $row->fuel_cost_per_km) }}"
                                        placeholder="Enter Fuel Cost 1/KM">
                            ...
                            <div class="col-md-12">
                                <div class="mb-6 ">
                                    ...
                                    <select name="is_online" class="form-control" required>
                            ...
                            @if ($row->license_back || $row->license_front)
                                <div class="col-md-12">
                                    <div class="mb-6 ">
