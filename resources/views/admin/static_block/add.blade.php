...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('postAddStaticBlock') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3 ">
                            ...
                            <input type="text" title="Title" class="form-control" name="title_en" value="{{ old('title_en') }}" placeholder="Title" required>                           
                            @error('title_en')
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 ">
                            ...
                            <input type="text" title="Title" class="form-control" name="title_fr" value="{{ old('title_fr') }}" placeholder="Title" required>                           
                            @error('title_fr')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 ">
                            ...
                            <input type="text" title="Title" class="form-control" name="title_de" value="{{ old('title_de') }}" placeholder="Title" required>                           
                            @error('title_de')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 ">
                            ...
                            <input type="text" title="Title" class="form-control" name="title_ae" value="{{ old('title_ae') }}" placeholder="Title" required>                           
                            @error('title_ae')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 ">
                            ...
                            <input type="text" title="Title" class="form-control" name="title_ka" value="{{ old('title_ka') }}" placeholder="Title" required>                           
                            @error('title_ka')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3 ">
                            ...
                            <textarea name="content_en" class="form-control" id="description_en">{{ old('content_en') }}</textarea>                      
                            @error('content_en')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3 ">
                            ...
                            <textarea name="content_fr" class="form-control" id="description_fr">{{ old('content_fr') }}</textarea>                      
                            @error('content_fr')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3 ">
                            ...
                            <textarea name="content_de" class="form-control" id="description_de">{{ old('content_de') }}</textarea>                      
                            @error('content_de')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3 ">
                            ...
                            <textarea name="content_ae" class="form-control" id="description_ae">{{ old('content_ae') }}</textarea>                      
                            @error('content_ae')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3 ">
                            ...
                            <textarea name="content_ae" class="form-control" id="description_ka">{{ old('content_ka') }}</textarea>                      
                            @error('content_ae')
                                <div class="text-danger mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                                </div>
