...
@section('content')
    <p><a title="Main Module" href="{{ route('getPrivilege') }}"><i class="fa fa-chevron-circle-left "></i> &nbsp; Back To List
            Data</a></p>
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('postUpdatePrivilege', $row->id) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="return_url" value="{{ route('getPrivilege') }}">
                        <div class="mb-3 ">
                            <label for="name" class="form-label">Privilege Name <span class="text-danger"
                                    title="This field is required">*</span></label>
                            <input type="text" title="name" class="form-control" name="name" id="name"
                                value="{{ old('name') ? old('name') : $row->name }}" placeholder="Enter Name" required>
                            @error('name')
                        ...
                        <div id="privileges_configuration" class="mb-3">
                            ...
                            <table class="table table-striped table-hover table-bordered">
                                <thead>
                                    ...
                                    <tr class="active">
                                        <th>&nbsp;</th> nnb tr5rt56nhtgrb
                                        <th>&nbsp;</th>
                                        <td align="center"><input title="Check all vertical" type="checkbox"
                                                id="is_visible"></td>
                        ...
                        <div class="row g-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <a href="{{ route('getPrivilege') }}" class="btn btn-default"><i
